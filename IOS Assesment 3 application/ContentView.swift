...
struct ContentViewB: View {
    ...
    var body: some View {
        ZStack{
            NavigationLink(destination: SearchStruc().navigationBarBackButtonHidden(true),isActive: $Search){
    ...
    var body: some View {
        ZStack{
            ...
            Text("Show more")
                ...
                .position(x: 195, y: 330)
            Text("Box hill Central")
                .position(x: 108, y: 90)
                .font(.system(size: 25))
            Text("Laburnum Station")
                .position(x: 126, y: 116)
                .font(.system(size: 25))
            Text("Mont Albert station")
                .position(x: 133, y: 142)
                .font(.system(size: 25))
            Text("Surrey Hills station")
                .position(x: 130, y: 171)
                .font(.system(size: 25))
            Image("Departure")
                .resizable()
                .scaledToFit()
                .frame(width: 1000, height: 174)
            ...
            Group{
                NavigationLink(destination: ContentViewB().navigationBarBackButtonHidden(true), isActive: $Home){
                    EmptyView()
                }
                Image("News")
                    .resizable()
